...
const CatSummary = ({id, category, thumbnail, title, subtitle, description, sourceRef}) => {
          ...
          <div className="card mx-auto" style={{"maxWidth": "900px", "minHeight": "200px", "borderRadius": "0px", "borderLeftWidth": "0px", "borderRightWidth": "0px", "borderTopWidth": "8px", "borderBottomWidth": "8px", "borderTopColor": "rgba(109, 207, 238, 0.22)", "borderBottomColor": "rgba(109, 207, 238, 0.22)"}}>
            <div className="row ">
                <div className="col-md-4 text-center my-auto">
                    <img src={avatarUrl} alt="" className="w-75" style={{"maxWidth": "75%", "paddingTop": "0%", "minHeight": "75%", "margin": "20px"}}></img>
                </div>
                    ...
                    <p className="card-text" style={{"marginTop": "10px"}}>{description}</p>
                        <div className="d-flex flex-row float-right" style={{"marginBottom": "20px"}}>
                          <Link to={`${category}/${id}`} style={{"color": "inherit"}}>
                            <button href={`${category}/${id}`} className="" style={{"borderRadius": "10px", "backgroundColor": "white", "outlineColor": "black", "borderWidth": "1px"}}>Read More</button>
                          </Link>

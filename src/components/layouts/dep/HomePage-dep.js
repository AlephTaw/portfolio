        ...
        return(
            <div>
                ...
                {/* <div className="text-center"> */}
                    ...
                    <div className="">
                        <div className="row">
                        <hr style={{"border": "4px", "borderColor": "6DCFEE"}}></hr>
                            <div className="col">
                                <div class="card mx-auto" style={{"maxWidth": "900px", "borderRadius": "0px", "borderLeftWidth": "0px", "borderRightWidth": "0px", "borderTopWidth": "4px", "borderBottomWidth": "4px", "borderTopColor": "rgba(109, 207, 238, 0.22)", "borderBottomColor": "rgba(109, 207, 238, 0.22)"}}>
                                <div className="d-flex flex-wrap">
                                    <div className="col" style={{"marginRight": "0px"}}>
                                        <img src={seedlingPic} alt="not found" style={{"borderRadius": 0, "width": "180px", "height": "135px", "marginLeft": "15px", "marginTop": "30px","marginBottom": "30px"}}></img>
                                    </div>
                                    <div className="col" style={{"marginRight": "15px"}}>
                                        <div className="row" style={{"marginTop": "20px"}}><h2>Exploration: Projects, Pipelines, and Sandboxes</h2></div>
                                        <div className="row" style={{"marginTop": "5px"}}>ICLR 2021 • lucidrains/vit-pytorch • </div>
                                        <div className="row" style={{"marginTop": "10px"}}><div>While the Transformer architecture has become the de-facto standard for natural language processing tasks, its applications to computer vision remain limited.</div></div>
                                    </div>
                                </div>
                                <div className="row" style={{"marginTop": "10px", "marginBottom": "0px"}}>
                                        <div className="col" style={{"borderRadius": 0, "width": "180px", "height": "0"}}></div>
                                        <div className="col"><button>Placehoder Text</button></div>
                                        <div className="col"  style={{"marginBottom": "0px"}}><button>View on Github</button></div>
                                </div>
                                {/* <div class="card-body">
